...
import { u as useProductCategoryStore, _ as _sfc_main$1$1, a as _sfc_main$2 } from './Alert-BzXgtGp_.mjs';
      ...
      _push(ssrRenderComponent(unref(Form), mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div><div class="form__group"${_scopeId}><label class="custom__file"${_scopeId}><input type="file" name="file" multiple accept="image/*"${_scopeId}><div class="custom__file__text"${_scopeId}><ol class="custom__file__list"${_scopeId}>`);
...
//# sourceMappingURL=category-llv8doVA.mjs.map
