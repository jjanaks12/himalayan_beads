...
import ImageBlock from './imageBlock-D5Sht63l.mjs';
import _sfc_main$2 from './productDescription-CeQH4lW_.mjs';
import _sfc_main$1 from './index-DRiYK4rQ.mjs';
...
import './TiptapEditor-uRjzH7Kj.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const fetchProductDetail = () => {
      var _a;
      $fetch("/api/product/" + ((_a = route.params) == null ? void 0 : _a.id)).then((data) => {
...
//# sourceMappingURL=_id_-CN7Nsm5p.mjs.map
