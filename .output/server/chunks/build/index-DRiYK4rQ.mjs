...
import _sfc_main$2 from './form-JBCRfvGB.mjs';
import './server.mjs';
import '../runtime.mjs';
import 'node:http';
import 'node:https';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div class="datatable__body"><table><thead><tr><td class="sn"></td><td class="text--left">Amount</td><td></td></tr></thead><tbody><!--[-->`);
...
//# sourceMappingURL=index-DRiYK4rQ.mjs.map
