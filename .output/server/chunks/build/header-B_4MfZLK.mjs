...
import { _ as _imports_1, a as _sfc_main$1 } from './virtual_public-D2Ypim1D.mjs';
import { defineComponent, ref, watch, mergeProps, withCtx, createTextVNode, createVNode, withModifiers, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrRenderAttr, ssrRenderComponent } from 'vue/server-renderer';
import { _ as _imports_0 } from './virtual_public-DA-13Mhu.mjs';
import { _ as _imports_2, a as _imports_3 } from './virtual_public-CPeK2MBM.mjs';
import '../runtime.mjs';
import 'node:http';
import 'node:https';
import 'node:zlib';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<header${ssrRenderAttrs(mergeProps({ id: "header" }, _attrs))}><div class="container container--lg"><a href="#" class="nav__opener"><span class="icon-add"></span><span class="icon-menu"></span></a><div class="logo"><a href="#"><img${ssrRenderAttr("src", _imports_0)} alt="Himalayan Beads"></a></div><nav id="nav"><ul class="main__menu"><li><a href="#">Rudraksha</a></li><li><a href="#">Custom Order</a></li><li><a href="#">Blog</a></li></ul><div class="nav__drop"><a href="#" class="nav__opener"><span class="icon-add"></span></a><strong class="greetings">Heya! Welcome to HB</strong>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`Login or sign up`);
          } else {
            return [
              createTextVNode("Login or sign up")
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_component_Dropdown, { class: "language" }, {
        opener: withCtx(({ clickHandler }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<a href="#" class="dropdown__opener"${_scopeId}><img${ssrRenderAttr("src", _imports_1)} alt="us-en"${_scopeId}><span class="text"${_scopeId}>English</span></a>`);
          } else {
            return [
              createVNode("a", {
                href: "#",
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<ul class="language__menu"${_scopeId}><li${_scopeId}><a href="#"${_scopeId}><img${ssrRenderAttr("src", _imports_1)} alt="us-en"${_scopeId}><span class="text"${_scopeId}>English</span></a></li><li${_scopeId}><a href="#"${_scopeId}><img${ssrRenderAttr("src", _imports_1)} alt="us-en"${_scopeId}><span class="text"${_scopeId}>Nepali</span></a></li></ul>`);
          } else {
            return [
...
//# sourceMappingURL=header-B_4MfZLK.mjs.map
