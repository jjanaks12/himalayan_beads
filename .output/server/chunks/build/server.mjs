...
const _routes = [
  {
    ...
    component: () => import('./login-Db04tmHi.mjs')
  },
  {
    name: "register",
    path: "/register",
  ...
  },
  {
    ...
    component: () => import('./category-BYXetRHw.mjs')
  },
  {
    name: "dashboard",
    path: "/dashboard",
