...
import { defineComponent, ref, mergeProps, unref, withCtx, createVNode, withModifiers, openBlock, createBlock, createTextVNode, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderClass } from 'vue/server-renderer';
import { Form, Field, ErrorMessage } from 'vee-validate';
import { _ as _sfc_main$1, r as registerSchema } from './account.schema-Cp-I7e_w.mjs';
      ...
      _push(ssrRenderComponent(unref(Form), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<a href="#" class="btn btn--xs btn__info btn--icon" tabindex="-1"${_scopeId}>`);
            ...
            _push2(`</a></div><div class="form__group"${_scopeId}><label for="rf__confirm_password"${_scopeId}>Confirm Password</label>`);
            _push2(ssrRenderComponent(unref(Field), {
              type: "password",
            ...
            return [
              ...
              createVNode("div", { class: "form__group" }, [
                ...
                createVNode("a", {
                  href: "#",
                  onClick: withModifiers(($event) => showPassword.value = !unref(showPassword), ["prevent"]),
                  class: "btn btn--xs btn__info btn--icon",
                  tabindex: "-1"
                }, [
                  unref(showPassword) ? (openBlock(), createBlock(_component_MdiIcon, {
                    key: 0,
                    preserveAspectRatio: "xMidYMid meet",
                    icon: "mdiEyeOutline",
                    size: "16"
                  })) : (openBlock(), createBlock(_component_MdiIcon, {
                    key: 1,
                    preserveAspectRatio: "xMidYMid meet",
                    icon: "mdiEyeOffOutline",
                    size: "16"
...
//# sourceMappingURL=register-RSlm2fQq.mjs.map
