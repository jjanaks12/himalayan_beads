...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const featuredProduct = computed(() => {
      var _a, _b, _c;
      let image = "";
      if (((_a = props.product) == null ? void 0 : _a.images.length) > 0) {
        const featuredImage = (_b = props.product) == null ? void 0 : _b.images.find((image2) => image2.featured);
        if (featuredImage)
          image = (_c = featuredImage == null ? void 0 : featuredImage.images) == null ? void 0 : _c.url;
      }
      return image;
    });
    return (_ctx, _push, _parent, _attrs) => {
...
//# sourceMappingURL=Item-BlgEb0Dk.mjs.map
