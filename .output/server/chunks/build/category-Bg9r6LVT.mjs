import { _ as _sfc_main$4 } from './ThemeButton-CqTpY8QS.mjs';
import { useSSRContext, defineComponent, ref, computed, watch, mergeProps, withCtx, createVNode, createTextVNode, unref, isRef, openBlock, createBlock, Fragment, renderList, toDisplayString, createCommentVNode, withModifiers } from 'vue';
...
import { u as useProductCategoryStore, _ as _sfc_main$3 } from './Alert-C3whoaLR.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_ThemeButton = _sfc_main$4;
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "datatable__section" }, _attrs))}><header class="datatable__header"><div class="datatable__header__holder"><h1>Product category</h1></div><div class="datatable__header__action">`);
      _push(ssrRenderComponent(_component_ThemeButton, {
        onClick: ($event) => showForm.value = true,
        persmission: "create_category"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="prepend-icon icon-add"${_scopeId}></span> Add Category `);
          } else {
            return [
              createVNode("span", { class: "prepend-icon icon-add" }),
      ...
      _push(`</div></header><div class="datatable__body"><table><thead><tr><th></th><th class="text--left">Name</th><th>Created at</th><th class="text--right">Action</th></tr></thead><tbody><!--[-->`);
      ssrRenderList(unref(categoryList), (category, index) => {
        ...
        _push(`</td></tr>`);
        if ((category == null ? void 0 : category.predecessor.length) > 0 && unref(toggleAccordion)[category == null ? void 0 : category.id]) {
          _push(`<tr><td colspan="4" class="no--spacing"><table class="subtable"><tbody><!--[-->`);
          ssrRenderList(category.predecessor, (subCategory, counter) => {
            _push(`<tr><td class="sn">${ssrInterpolate(index + 1)}.${ssrInterpolate(counter + 1)}</td><td class="text--center">${ssrInterpolate(subCategory.name)}</td><td>${ssrInterpolate(unref(formatDate)(subCategory.createdAt))}</td><td class="text--right">`);
            _push(ssrRenderComponent(_component_ThemeButton, {
              onClick: ($event) => editCategory.value = subCategory,
              persmission: "update_category"
            }, {
              default: withCtx((_, _push2, _parent2, _scopeId) => {
                if (_push2) {
                  _push2(`<span class="prepend-icon icon-edit"${_scopeId}></span> Edit `);
                } else {
                  return [
                    createVNode("span", { class: "prepend-icon icon-edit" }),
            ...
            _push(ssrRenderComponent(_component_ThemeButton, {
              onClick: ($event) => deletingCategory.value = subCategory,
              persmission: "delete_category"
            }, {
              default: withCtx((_, _push2, _parent2, _scopeId) => {
                if (_push2) {
                  _push2(`<span class="prepend-icon icon-trash"${_scopeId}></span> Delete `);
                } else {
                  return [
                    createVNode("span", { class: "prepend-icon icon-trash" }),
...
//# sourceMappingURL=category-Bg9r6LVT.mjs.map
