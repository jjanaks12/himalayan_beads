              ...
              >
                ...
                >
                  ...
                  <NuxtLink
                    ...
                    to="/cart"
                    @click.stop
                    class="add__to__cart__btn cursor-pointer bg-[#804224] font-bold border border-[#804224] text-white px-4 py-2 rounded text-xs font-medium transition-all duration-300 flex items-center gap-1 transform hover:scale-105"
                  >
