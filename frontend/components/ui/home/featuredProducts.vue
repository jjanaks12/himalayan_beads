...
/* 
  Note: While these media queries work, Tailwind's responsive prefixes 
  (like sm:grid-cols-2, lg:gap-6) already handle this in the template. 
  Keeping them ensures 100% fidelity to your original design.
*/
